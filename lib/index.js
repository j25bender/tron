...
function startScreen(e) {
    ...
    InitialStartScreen.drawOnePlayerBttn(context);
    InitialStartScreen.drawTwoPlayerBttn(context);
    InitialStartScreen.drawOnePlayerText(context);
    InitialStartScreen.drawTwoPlayerText(context);
}
