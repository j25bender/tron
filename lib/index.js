...
let InitialStartScreen = new StartScreen();
let onePlayerBttn = new StartScreen(75, 420, 150, 50, 'gray');
let twoPlayerBttn = new StartScreen(375, 420, 150, 50, 'gray');
let onePlayerText = new StartScreen(90, 445, 0, 0, 'white');
let twoPlayerText = new StartScreen(390, 445, 0, 0, 'white');
