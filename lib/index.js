...
const P1LvlOneDirect = require('./P1LvlOneDirect.js');
...
const P1LvlOneDirections = new P1LvlOneDirect();
const spaceBarBttn = new P1LvlOneDirect(0, 550, 600, 50, 'gray');
const spaceBarText = new P1LvlOneDirect(170, 570, 600, 30, 'white');
...
function mouseClick(e) {
    ...
    if( y >= 425 && y <= 480 && x >= 75 && x<= 225) {
        ...
        requestAnimationFrame( function gameLoop() {
            ...
            P1LvlOneDirections.drawP1Directions(context);
            spaceBarBttn.drawSpacebarBttn(context);
            spaceBarText.drawSpacebarText(context);
            // drawArrows();
        });
