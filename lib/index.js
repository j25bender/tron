...
function gameLoop() {
  ...
  lightCycles.forEach( lightCycle => {
    ...
    if (lightCycle.checkBorderCollisions() || lightCycle.checkOwnTrailCollisions()) {
      checkWinner(lightCycle.checkOwnTrailCollisions());
...
function checkWinner(color) {
  if (color === '#EE6A2C') {
    ...
    enterBttn.drawEnterBttn(context);
    enterText.drawEnterText(center, context);
//     resetCyclesOnEndGame();
  } 
}

// function resetCyclesOnEndGame() {
//   let lightCycle1;
//   let lightCycle2;
//   if (this.collided === true) {
//     console.log('resetCyclesOnEndGame')
//     lightCycles.forEach( (lightCycle) => {
//       lightCycle.draw(context);
//       context.clearRect(0, 0, canvas.width, canvas.height)
//       this.direction = 'none';
//     })
//     lightCycle1 = new LightCycle(100, 300, 50, 4, '#7AF6D8', 'none');
//     lightCycle1 = new LightCycle(450, 300, 50, 4, '#EE6A2C', 'none');
//     return;
//   }
// }